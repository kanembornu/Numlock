function runAllBackendTests()
{
  var tests = [
    ...
    { name: "testPartialBalancePositionReport", run: testPartialBalancePositionReport },
    { name: "testPartialBalanceEquityUnavailable", run: testPartialBalanceEquityUnavailable },
    { name: "testPartialBalanceNoFixedAssets", run: testPartialBalanceNoFixedAssets },

...
function createAccessibilityContractFixtures()
{
  return [
    ...
    { name: "scoped table headers", tokens: ['<th scope="col" class="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider">Date</th>', '<th scope="col" class="px-4 py-3 text-right text-xs font-bold uppercase tracking-wider">Amount</th>'] },

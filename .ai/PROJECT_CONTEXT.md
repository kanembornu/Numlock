...
- P0 product gaps are empty/sparse-data resilience and the visible transaction filter that currently reloads the same unfiltered response. Purchase-only semantics require approval before filter implementation.
